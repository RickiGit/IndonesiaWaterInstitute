<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Create Slide Header</h1>

    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Create Slide Header</h6>
        </div>
        <div class="card-body">
            <form enctype="multipart/form-data" id="submitSlideHeader">
                <div class="row">
