<div class="container-fluid">
            ...
            <form enctype="multipart/form-data" id="submitEditUser" action="<?php echo base_url()?>admin/updateuser/<?php echo $user['id']?>">
                <div class="row">
                    ...
                    <input type="hidden" name="id" id="id" value="<?php echo $user['id']?>">
                        ...
                        <input type="hidden" name="currentImage" id="currentImage" class="form-control m-bottom10" value="<?php echo $user['image']?>">
                    </div>
                    <div class="col col-md-6">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form enctype="multipart/form-data" id="submitEditUserPassword" action="<?php echo base_url()?>admin/updatepassword/<?php echo $user['id']?>">
                <div class="row">
                    <div class="col col-md-6">
                        <label class="m-bottom5">Current Password*</label>
                        <input type="password" name="currentpassword" id="currentpassword" class="form-control m-bottom10" value="<?php $user['password']?>">
                        <label class="m-bottom5">New Password*</label>
                        <input type="password" name="password" id="password" class="form-control m-bottom10" value="<?php $user['password']?>">
