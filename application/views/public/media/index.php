          ...
          ?>
            <div class="col-lg-6 col-md-6 d-flex align-items-stretch" data-aos="fade-up">
              <article class="entry">
                ...
                <div class="entry-img">
                  <img src="<?php echo base_url()?>assets/images/news/<?php echo $n->cover?>" style="height:190px" alt="" class="img-fluid">
                </div>
                ...
                <div class="entry-content">
                  ...
                  <div class="read-more">
                    <a href="<?php echo base_url()?>media/detail/<?php echo rawurlencode($n->title)?>"><?php echo $this->lang->line('readmore') ?></a>
                  </div>
                </div>
