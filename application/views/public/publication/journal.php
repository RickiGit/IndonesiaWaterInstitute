...
<section id="contact" class="contact">
  <div class="container" data-aos="fade-up">   
    <ul class="nav nav-pills">
        <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url()?>publication/book"><?php echo $this->lang->line('book')?></a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="<?php echo base_url()?>publication/journal"><?php echo $this->lang->line('journal')?></a>
        </li>
    </ul>
    ...
    <table class="table table-striped" style="margin-top:20px">
        <thead>
            <tr>
                ...
                <th><?php echo $this->lang->line('papertitle')?></th>
                <th><?php echo $this->lang->line('author')?></th>
                <th><?php echo $this->lang->line('publisherpaper')?></th>
                <th></th>
            </tr>
        </thead>
        <tbody>
